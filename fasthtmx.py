...
@rt("/")
def get():
    inp = Input(id="new-title", name="title", placeholder="New item")
    ...
    return Titled('Shopping List', card)


@rt("/")
def post(todo: Todo):
    return todos.insert(todo), Input(id="new-title", name="title", placeholder="New item", hx_swap_oob='true')
